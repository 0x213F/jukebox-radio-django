...
# jukebox_radio/
APPS_DIR = ROOT_DIR / "jukebox_radio"
env = environ.Env()
...
DATABASES = pgconnection.configure({"default": env.db("DATABASE_URL")})
...
MIGRATION_MODULES = {"sites": "jukebox_radio.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "jukebox_radio.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""0x213F""", "developer@0x213F.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "jukebox_radio.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "jukebox_radio.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
