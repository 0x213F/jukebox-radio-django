# Generated by Django 3.1.2 on 2020-12-13 18:38

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import jukebox_radio.music.models.collection
import jukebox_radio.music.models.stem
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(null=True, upload_to=jukebox_radio.music.models.collection.upload_to_collections_imgs)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_ms', models.PositiveIntegerField(blank=True, null=True)),
                ('audio', models.FileField(blank=True, null=True, upload_to=jukebox_radio.music.models.track.upload_to_tracks_audios)),
                ('external_id', models.CharField(blank=True, max_length=200, null=True)),
                ('img', models.ImageField(blank=True, null=True, upload_to=jukebox_radio.music.models.track.upload_to_tracks_imgs)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('bass', 'Bass'), ('drums', 'Drums'), ('vocals', 'Vocals'), ('other', 'Other')], max_length=32)),
                ('audio', models.FileField(upload_to=jukebox_radio.music.models.stem.upload_to_stems_audios)),
