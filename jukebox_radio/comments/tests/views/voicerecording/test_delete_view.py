...
def test_voice_recording_delete_view_assert_request_type(client):
    """
...
@pytest.mark.django_db
def test_voice_recording_delete_view_request_authentication_required(client):
    """
...
@pytest.mark.django_db
def test_voice_recording_delete_view_happy_path(client):
    """
